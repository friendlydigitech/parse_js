...
n.prototype={VERSION:"2.5.7",_markers:[],_labels:[],_polylines:[],_polygons:[],_circles:[],_kmls:[],_directions:[],bounds:new google.maps.LatLngBounds,setZoom:function(a,b){f(b,"zoom")&&a&&a.setZoom(b.zoom)},kml:function(a,b){b=b?b:this.options;var c={},d="",c={};e!==b.kml&&(c={preserveViewport:!0,suppressInfoWindows:!1},d="string"===typeof b.kml&&0!==b.kml.length?b.kml:e!==b.kml.url?b.kml.url:"",c=new google.maps.KmlLayer(d,h.extend(c,b.kml)),this._kmls.push(c),c.setMap(a))},direction:function(a,
...
this.options;if(e!==b.polyline&&e!==b.polyline.coords){for(c in b.polyline.coords)f(b.polyline.coords,c)&&(d=b.polyline.coords,e!==d[c]&&k.push(new google.maps.LatLng(d[c][0],d[c][1])));c=new google.maps.Polyline({path:k,strokeColor:b.polyline.color||"#FF0000",strokeOpacity:1,strokeWeight:b.polyline.width||2});this._polylines.push(c);c.setMap(a)}},DrawPolygon:function(a,b){var c={},c="",d={},k=[];b=b?b:this.options;if(e!==b.polygon&&e!==b.polygon.coords){for(c in b.polygon.coords)f(b.polygon.coords,
c)&&(d=b.polygon.coords,e!==d[c]&&k.push(new google.maps.LatLng(d[c][0],d[c][1])));c=new google.maps.Polygon({path:k,strokeColor:b.polygon.color||"#FF0000",strokeOpacity:1,strokeWeight:b.polygon.width||2,fillColor:b.polygon.fillcolor||"#CC0000",fillOpacity:0.35});this._polygons.push(c);c.setMap(this.map);h.isFunction(b.polygon.click)&&google.maps.event.addListener(c,"click",b.polygon.click)}},DrawCircle:function(a,b){var c=0,d={},d={};b=b?b:this.options;if(e!==b.circle&&0<b.circle.length)for(c=b.circle.length-
...
this.markers(this.map);this.DrawPolyline(this.map);this.DrawPolygon(this.map);this.DrawCircle(this.map)},MarkerDirect:function(a){var b,c;c={map:this.map,position:new google.maps.LatLng(a.addr[0],a.addr[1]),title:a.text.replace(/<([^>]+)>/g,""),infoWindow:new google.maps.InfoWindow({content:a.text})};b={};b={};"string"===typeof a.icon?c.icon=a.icon:f(a.icon,"url")&&(b=f(a.icon,"anchor")&&e!==a.icon.anchor[1]?new google.maps.Point(a.icon.anchor[0],a.icon.anchor[1]):new google.maps.Point(0,0),b=new google.maps.MarkerImage(a.icon.url,
null,new google.maps.Point(0,0),b),c.icon=b);b=new google.maps.Marker(c);this._markers.push(b);f(b,"position")&&b.getPosition().lat()&&b.getPosition().lng()&&this.bounds.extend(c.position);c={map:this.map,css:e!==a.css?a.css:""};"string"===typeof a.label&&0!==a.label.length&&(c.text=a.label);c=new l(c);c.bindTo("position",b,"position");c.bindTo("text",b,"position");c.bindTo("visible",b);this.bindEvent(b,a.event)},MarkerByGeocoder:function(a){var b=new google.maps.Geocoder,c=this;-1!==a.addr.indexOf(",")&&
(a.addr="loc: "+a.addr);b.geocode({address:a.addr},function(b,k){if(k===google.maps.GeocoderStatus.OVER_QUERY_LIMIT)m.setTimeout(function(){c.MarkerByGeocoder(a)},c.interval);else if(k===google.maps.GeocoderStatus.OK){var e,g;g={map:c.map,position:b[0].geometry.location,title:a.text.replace(/<([^>]+)>/g,""),infoWindow:new google.maps.InfoWindow({content:a.text})};"string"===typeof a.icon&&(g.icon=a.icon);e=new google.maps.Marker(g);c._markers.push(e);f(e,"position")&&e.getPosition().lat()&&e.getPosition().lng()&&
c.bounds.extend(g.position);g={map:c.map,css:a.css||""};"string"===typeof a.label&&0!==a.label.length&&(g.text=a.label);g=new l(g);g.bindTo("position",e,"position");g.bindTo("text",e,"position");g.bindTo("visible",e);c.bindEvent(e,a.event)}})},DirectionService:function(a){var b=[],c=new google.maps.DirectionsService,d=new google.maps.DirectionsRenderer,k={travelMode:google.maps.DirectionsTravelMode.DRIVING,optimizeWaypoints:a.optimize||!1},f=0,g=0;"string"===typeof a.from&&(k.origin=a.from);"string"===
typeof a.to&&(k.destination=a.to);"string"===typeof a.travel&&0<a.travel.length&&(k.travelMode=google.maps.DirectionsTravelMode[a.travel.toUpperCase()]);if(e!==a.waypoint&&0!==a.waypoint){f=0;for(g=a.waypoint.length;f<g;f+=1)b.push({location:a.waypoint[f].toString(),stopover:!0});k.waypoints=b}e!==k.origin&&e!==k.destination&&(c.route(k,function(a,b){b===google.maps.DirectionsStatus.OK&&d.setDirections(a)}),d.setMap(this.map),this._directions.push(d))},bindEvent:function(a,b){var c=this;"function"===
typeof b?google.maps.event.addListener(a,"click",b):f(b,"type")?"string"===typeof b.type&&"function"===typeof b.bind&&google.maps.event.addListener(a,b.type,b.bind):google.maps.event.addListener(a,"click",function(){a.infoWindow.open(c.map,a)})},init:function(){var a=this,b={};p+=1;"string"===typeof this.options.center?m.setTimeout(function(){var c=h(a.container),d="";-1!==a.options.center.indexOf(",")&&(a.options.center="loc: "+a.options.center);b=new google.maps.Geocoder;b.geocode({address:a.options.center},
function(b,f){try{f===google.maps.GeocoderStatus.OVER_QUERY_LIMIT?a.init():f===google.maps.GeocoderStatus.OK&&0!==b.length?(a.GoogleMapOptions.center=f===google.maps.GeocoderStatus.OK&&0!==b.length?b[0].geometry.location:"",a.map=new google.maps.Map(a.container,a.GoogleMapOptions),google.maps.event.addListenerOnce(a.map,"idle",function(){a.overlay();a.options.marker.length&&!0===a.options.markerFitBounds&&setTimeout(function(){a.map.fitBounds(a.bounds)},a.interval)})):(d=a.options.notfound.text||
f,c.html(d.replace(/</g,"&lt;").replace(/>/g,"&gt;")))}catch(g){c.html((e!==g.message?g.message:g.description).toString())}})},a.interval*p):(a.map=new google.maps.Map(a.container,a.GoogleMapOptions),google.maps.event.addListenerOnce(a.map,"idle",function(){a.overlay();a.options.marker.length&&!0===a.options.markerFitBounds&&a.map.fitBounds(a.bounds)}))},panto:function(a){var b=this,c="",d={};f(b,"map")&&null!==b.map&&e!==b.map&&("string"===typeof a?(-1!==a.indexOf(",")&&(c="loc: "+a),d=new google.maps.Geocoder,
d.geocode({address:a},function(a,c){c===google.maps.GeocoderStatus.OK&&h.isFunction(b.map.panTo)&&e!==a[0]&&b.map.panTo(a[0].geometry.location)})):("[object Array]"===Object.prototype.toString.call(a)?2===a.length&&(c=new google.maps.LatLng(a[0],a[1])):f(a,"lat")&&f(a,"lng")?c=new google.maps.LatLng(a.lat,a.lng):f(a,"x")&&f(a,"y")&&(c=new google.maps.LatLng(a.x,a.y)),h.isFunction(b.map.panTo)&&e!==c&&b.map.panTo(c)))},clear:function(a){var b=[],c="",d=0,f=0;"string"===typeof a&&(b=a.split(","));for(d=
0;d<b.length;d+=1)if(c="_"+h.trim(b[d].toString().toLowerCase())+"s",e!==this[c]&&this[c].length){for(f=0;f<this[c].length;f+=1)this.map===this[c][f].getMap()&&(this[c][f].set("visible",!1),this[c][f].setMap(this.map,null));this[c]=[]}},modify:function(a){var b=[],c=[["kml","kml"],["marker","markers"],["direction","direction"],["polyline","DrawPolyline"],["polygon","DrawPolygon"],["circle","DrawCircle"],["zoom","setZoom"]],d=0;if(e!==a){for(d=0;d<c.length;d+=1)f(a,c[d][0])&&b.push(c[d][1]);if(null!==
this.map&&e!==this.map&&b)for(d=0;d<b.length;d+=1)if("function"===typeof this[b[d]])this[b[d]](this.map,a)}}};h.fn.tinyMap=function(a){var b=arguments,c=[],d={};return"string"===typeof a?(this.each(function(){d=h.data(this,"tinyMap");d instanceof n&&"function"===typeof d[a]&&(c=d[a].apply(d,Array.prototype.slice.call(b,1)))}),e!==c?c:this):this.each(function(){h.data(this,"tinyMap")||h.data(this,"tinyMap",new n(this,a))})}})(jQuery,window,document);